...
rem dotnet build --no-restore SourceCode/AgOpenGPS.sln

dotnet publish --no-restore --configuration Release SourceCode/AgOpenGPS.sln --property:Version="6.8.0.32"
